...
def mark(req: MarkRequest):
    ...
    try:
        ...
        feedback = "Correct ✅" if correct else f"Not quite. Tip: check order of operations."
        return MarkResponse(ok=True, correct=correct, score=score, feedback=feedback, expected=expected)
    except Exception:
